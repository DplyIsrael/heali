...
-- 2. New table: stores the 5 client references uploaded during onboarding
--    step 6 (המלצות של לקוחות). Same shape as the invoices table.
...
-- 3. New column on practitioner_profiles for the bio step's
