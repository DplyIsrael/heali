...
const PRICING_MODELS = [
  {
    ...
    label: "מחיר לטיפול",
    description:
      "עלות הטיפול בHeali לא יכול לעלות על התמחור בקליניקה הפרטית שלך",
  },
  {
    value: "per_heali_package",
    label: "אני רוצה להופיע בחבילות הטיפולים של Heali.",
    description:
      'מטפלים שנמצאים בחבילות הטיפול של Heali מקבלים הרבה יותר מטופלים. כל המטפלים בחבילות הטיפול של Heali הם במחיר אחיד של 140ש"ח פלוס מעמ.',
  },
];
