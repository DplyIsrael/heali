...
function SupportIcon() {
  return (
    <div className="absolute right-[40px] top-[30px] size-[58px] rounded-full bg-accent border-[1.3px] border-white flex items-center justify-center">
...
export function HelpBanner() {
  return (
    <section className="mx-auto max-w-[1440px] px-[50px] py-4">
      <div className="rounded-[16px] bg-[#1d4847] overflow-hidden relative h-[300px]">

        {/* ── Left side: decorative constellation ── */}
        <div className="absolute left-[50px] top-1/2 -translate-y-1/2 w-[500px] h-[400px]">
          {/* Large center circle */}
        ...
        {/* ── Right side: text + CTA ── */}
        <div className="absolute right-[80px] top-1/2 -translate-y-1/2 flex flex-col gap-[40px] items-end w-[574px]">
          {/* Headline */}
          <div className="text-[60px] font-semibold text-white text-right leading-[60px] w-full">
            <p>צריכים עזרה?</p>
