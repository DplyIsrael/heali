...
const FAQ_ITEMS = [
  {
    q: "למה דווקא הילי?",
    a: "הילי הוא האתר היחיד שמרכז עבורך את כל הטיפולים והמטפלים במקום אחד. כאן קל לסנן ולבחור את הטיפול המדויק בשבילך, כשכל המטפלים עברו בקרת איכות והם הטובים ביותר בתחומם. מעבר לזה, אנחנו תמיד זמינים לתת ייעוץ אישי, ולעזור לך למצוא את הטיפול שהכי נכון עבורך. ולא רק זה, המטפלים בהילי מציעים מחירים נוחים יותר מאלה שבקליניקות הפרטיות, לצד חבילות טיפול מוזלות, היסטוריית טיפולים מסודרת וצוות נגיש לכל התייעצות או שאלה.",
  },
  {
    q: "איך אוכל לדעת שהמטפלים בהילי באמת מקצועיים?",
    a: "אם יש משהו שלא התפשרנו עליו זה מקצועיות המטפלים. כל מטפל ומטפלת בהילי עברו סינון קפדני, כדי שנוכל להיות בטוחים שהטיפול שמגיע לך הוא הטוב ביותר.",
  },
  {
    q: "מה ההבדל בין הילי לבין חיפוש מטפל בגוגל או בפייסבוק?",
    a: "בהילי אנחנו מתאימים עבורך מטפל או מטפלת בדיוק לפי הצורך שלך, ומאפשרים לך למצוא מטפלים נוספים לפי מסננים כמו אזור, סוג טיפול ועוד. בנוסף לזה, יש לנו צוות מקצועי שזמין בשבילך בווטסאפ, כדי לעזור לך למצוא את ההתאמה המושלמת. במנועי חיפוש או רשתות חברתיות קשה לדעת מי המטפל ומה ההכשרה שלו. אצלנו כל המטפלים עברו סינון ובדיקת איכות, כך שאפשר להיות רגועים ולדעת שמקבלים את הטוב ביותר.",
  },
  {
  ...
  },
  {
    ...
    a: "זה ממש בסדר! בהילי יש לנו מבחר עצום של אפשרויות. לא התחברת למטפל או מטפלת? אפשר לכתוב לנו, ואנחנו נעשה התאמה מחודשת - עד שיהיה לך נוח ונעים.",
  },
  {
  ...
  },
  {
    ...
    a: "בטח! היתרון שלנו בהילי זה שאנחנו מרכזים לך את כל הטיפולים בחשבונית אחת נוחה כדי שאפשר יהיה להעביר לחברות ביטוח/הקרן לסיוע/ביטוח לאומי ועוד. גם בנושא הזה אנחנו זמינים כדי לעזור במה שצריך.",
  },
];
