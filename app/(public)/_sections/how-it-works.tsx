  ...
  return (
    <section className="mx-auto max-w-[1440px] px-[50px] py-16">
      <div className="mb-12 text-center">
        ...
        <p className="mt-2 text-[16px] font-light text-muted-foreground">
          {t("subtitle")}
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-8">
        {STEPS.map((step) => (
          <div
            key={step.number}
            className="relative flex flex-col items-center rounded-[20px] border border-border-input bg-white p-8 text-center"
          >
            {/* Step number */}
